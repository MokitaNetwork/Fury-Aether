...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&LendPairsProposal{}, "aether/AddLendPairsProposal")
	govtypes.RegisterProposalType(ProposalAddPool)
	govtypes.RegisterProposalTypeCodec(&AddPoolsProposal{}, "aether/AddPoolsProposal")
	govtypes.RegisterProposalType(ProposalAddAssetToPair)
	govtypes.RegisterProposalTypeCodec(&AddAssetToPairProposal{}, "aether/AddAssetToPairProposal")
	govtypes.RegisterProposalType(ProposalAddAssetRatesParams)
	govtypes.RegisterProposalTypeCodec(&AddAssetRatesParams{}, "aether/AddAssetRatesParams")
	govtypes.RegisterProposalType(ProposalAddAuctionParams)
	govtypes.RegisterProposalTypeCodec(&AddAuctionParamsProposal{}, "aether/AddAuctionParamsProposal")
}
