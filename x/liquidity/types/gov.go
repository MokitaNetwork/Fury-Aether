...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdateGenericParamsProposal{}, "aether/UpdateGenericParams")
	govtypes.RegisterProposalTypeCodec(&CreateNewLiquidityPairProposal{}, "aether/CreateNewLiquidityPair")
}
