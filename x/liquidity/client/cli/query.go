...
$ %s query %s pool 1 --reserve-address=aether...
`,
				version.AppName, types.ModuleName,
				version.AppName, types.ModuleName,
				version.AppName, types.ModuleName,
...
Example:
$ %s query %s orders 1 aether...
$ %s query %s orders 1 --pair-id=1 aether...
...
> {coins : [1000000uaeth, 4000000ufusd]}
`,
				version.AppName, types.ModuleName,
			),
		),
