...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&AddAssetsProposal{}, "aether/AddAssetsProposal")

	govtypes.RegisterProposalType(ProposalUpdateAsset)
	govtypes.RegisterProposalTypeCodec(&UpdateAssetProposal{}, "aether/UpdateAssetProposal")

	govtypes.RegisterProposalType(ProposalAddPairs)
	govtypes.RegisterProposalTypeCodec(&AddPairsProposal{}, "aether/AddPairsProposal")

	govtypes.RegisterProposalType(ProposalUpdatePair)
	govtypes.RegisterProposalTypeCodec(&UpdatePairProposal{}, "aether/UpdatePairProposal")

	govtypes.RegisterProposalType(ProposalUpdateGovTimeInApp)
	govtypes.RegisterProposalTypeCodec(&UpdateGovTimeInAppProposal{}, "aether/UpdateGovTimeInAppProposal")

	govtypes.RegisterProposalType(ProposalAddApp)
	govtypes.RegisterProposalTypeCodec(&AddAppProposal{}, "aether/AddAppProposal")

	govtypes.RegisterProposalType(ProposalAddAssetInApp)
	govtypes.RegisterProposalTypeCodec(&AddAssetInAppProposal{}, "aether/AddAssetInAppProposal")
}
