...
// source: aether/liquidation/v1beta1/tx.proto
...
func (*MsgLiquidateVaultRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_25adfd4d970ee606, []int{0}
}
...
func (*MsgLiquidateVaultResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_25adfd4d970ee606, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgLiquidateVaultRequest)(nil), "aether.liquidation.v1beta1.MsgLiquidateVaultRequest")
	proto.RegisterType((*MsgLiquidateVaultResponse)(nil), "aether.liquidation.v1beta1.MsgLiquidateVaultResponse")
}

func init() {
	proto.RegisterFile("aether/liquidation/v1beta1/tx.proto", fileDescriptor_25adfd4d970ee606)
}

var fileDescriptor_25adfd4d970ee606 = []byte{
	// 337 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x4e, 0x4c, 0x2d, 0xc9,
	0x48, 0x2d, 0xd2, 0xcf, 0xc9, 0x2c, 0x2c, 0xcd, 0x4c, 0x49, 0x2c, 0xc9, 0xcc, 0xcf, 0xd3, 0x2f,
	...
	0xea, 0x82, 0x38, 0xc5, 0x29, 0xf4, 0xc4, 0x43, 0x39, 0x86, 0x15, 0x8f, 0xe4, 0x18, 0x4e, 0x3c,
	...
	0x2f, 0x39, 0x3f, 0x57, 0x3f, 0x37, 0x3f, 0x3b, 0xb3, 0x24, 0x31, 0x2f, 0xb5, 0xa4, 0x3c, 0xbf,
	0x28, 0x5b, 0x1f, 0x1a, 0xd3, 0x15, 0x28, 0x71, 0x5d, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06,
	0x8e, 0x35, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf3, 0x76, 0xac, 0x6b, 0x0e, 0x02, 0x00,
	0x00,
}
...
func (c *msgClient) MsgLiquidateVault(ctx context.Context, in *MsgLiquidateVaultRequest, opts ...grpc.CallOption) (*MsgLiquidateVaultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aether.liquidation.v1beta1.Msg/MsgLiquidateVault", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_MsgLiquidateVault_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aether.liquidation.v1beta1.Msg/MsgLiquidateVault",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "aether.liquidation.v1beta1.Msg",
	...
	Metadata: "aether/liquidation/v1beta1/tx.proto",
}
