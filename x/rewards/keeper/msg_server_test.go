...
import (
	...
	keeper "github.com/mokitanetwork/aether/x/rewards/keeper"
...
func (s *KeeperTestSuite) TestCreateLocker() {
	...
	s.fundAddr(userAddress, sdk.NewCoin("uaeth", sdk.NewIntFromUint64(1000000000)))
...
func (s *KeeperTestSuite) TestCreateVault() {
	...
	extendedVaultPairID1 := s.CreateNewExtendedVaultPair("AETH-C", 1, pairID, false, true)
	...
	s.fundAddr(userAddress1, sdk.NewCoin("uaeth", sdk.NewIntFromUint64(1000000000)))
