...
func InitializeStates(
	...
	assets := []assettypes.Asset{
		...
		{Name: "sAETH", Denom: "ucaeth", Decimals: sdk.NewInt(1000000), IsOnChain: true, IsOraclePriceRequired: false, IsCdpMintable: true},
		{Name: "sFUSD", Denom: "ucfusd", Decimals: sdk.NewInt(1000000), IsOnChain: true, IsOraclePriceRequired: false, IsCdpMintable: true},
