...
func InitializeStates(
	...
	genesisToken := assettypes.MintGenesisToken{
		...
		IsGovToken:    true,
		Recipient:     "aether1tadhnvwa0sqzwr3m60f7dsjw4ua77qsz3ptcyw",
	}
	...
	assets := []assettypes.Asset{
		...
		{Name: "AETH", Denom: "uaeth", Decimals: sdk.NewInt(1000000), IsOnChain: false, IsOraclePriceRequired: true, IsCdpMintable: false},
		{Name: "FUSD", Denom: "ufusd", Decimals: sdk.NewInt(1000000), IsOnChain: true, IsOraclePriceRequired: true, IsCdpMintable: true},
		...
		{Name: "sAETH", Denom: "usaeth", Decimals: sdk.NewInt(1000000), IsOnChain: true, IsOraclePriceRequired: false, IsCdpMintable: true},
		{Name: "sFUSD", Denom: "usfusd", Decimals: sdk.NewInt(1000000), IsOnChain: true, IsOraclePriceRequired: false, IsCdpMintable: true},
	...
	extPairs := []*bindings.MsgAddExtendedPairsVault{
		{
			...
			PairName: "AXL-USDC-FUSD", AssetOutOraclePrice: false, AssetOutPrice: 1000000, MinUsdValueLeft: 10000000000,
		},
	}
	...
	liquidityPairs := []LiquidityPair{
		{AppID: 1, From: "aether12gfx7e3p08ljrwhq4lxz0360czcv9jpzajlytv", BaseCoinDenom: "uaeth", QuoteCoinDenom: "ibc/961FA3E54F5DCCA639F37A7C45F7BBE41815579EF1513B5AFBEFCFEB8F256352"},
		{AppID: 1, From: "aether12gfx7e3p08ljrwhq4lxz0360czcv9jpzajlytv", BaseCoinDenom: "uaeth", QuoteCoinDenom: "ibc/0471F1C4E7AFD3F07702BEF6DC365268D64570F7C1FDC98EA6098DD6DE59817B"},
		{AppID: 1, From: "aether12gfx7e3p08ljrwhq4lxz0360czcv9jpzajlytv", BaseCoinDenom: "uaeth", QuoteCoinDenom: "ufusd"},
		{AppID: 1, From: "aether12gfx7e3p08ljrwhq4lxz0360czcv9jpzajlytv", BaseCoinDenom: "uaeth", QuoteCoinDenom: "uharbor"},
	}
