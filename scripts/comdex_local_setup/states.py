...
ASSETS = [
    ...
    ["AETH", "uaeth",1000000, 0, 1, 0],  # ID - 2
    ["FUSD", "ufusd",1000000, 1, 1, 1],  # ID - 3
    ["OSMO", "uosmo",1000000, 0, 1, 0],  # ID - 4
    ["sATOM", "usatom",1000000, 1, 0, 1],  # ID - 5
    ["sAETH", "usaeth",1000000, 1, 0, 1],  # ID - 6
    ["sFUSD", "usfusd",1000000, 1, 0, 1],  # ID - 7
...
ADD_ASSET_RATES = [
    ...
    [
        "FUSD",
        {
            ...
            "reserve_factor": "0.1",
            "c_asset_id": "7",
            "title": "Add Asset Rates Stats FUSD",
            "description": "adding asset rates stats for FUSD",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "ATOM",
    ...
    [
        "AETH",
        {
            ...
            "reserve_factor": "0.2",
            "c_asset_id": "6",
            "title": "Add Asset Rates Stats AETH",
            "description": "adding asset rates stats AETH",
            "deposit": "10000000uaeth",
        },
    ],
]
...
ADD_LEND_PAIR = [
    [
        "AETH-FUSD",
        {
            ...
            "title": "Add Extended pair AETH-FUSD",
            "description": "adding extended pairs for AETH-FUSD same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "AETH-ATOM",
        {
            ...
            "asset_out_pool_id": "1",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair AETH-ATOM",
            "description": "adding extended pairs AETH-ATOM same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "ATOM-AETH",
        {
            ...
            "asset_out_pool_id": "1",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair ATOM-AETH",
            "description": "adding extended pairs ATOM-AETH same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "ATOM-FUSD",
        {
            ...
            "asset_out_pool_id": "1",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair ATOM-FUSD",
            "description": "adding extended pairs ATOM-FUSD same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "FUSD-AETH",
        {
            ...
            "asset_out_pool_id": "1",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair FUSD-AETH",
            "description": "adding extended pairs FUSD-AETH same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "FUSD-ATOM",
        {
            ...
            "asset_out_pool_id": "1",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair FUSD-ATOM",
            "description": "adding extended pairs FUSD-ATOM same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "OSMO-FUSD",
        {
            ...
            "asset_out_pool_id": "2",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair OSMO-FUSD",
            "description": "adding extended pairs OSMO-FUSD same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
    ...
    [
        "FUSD-OSMO",
        {
            ...
            "asset_out_pool_id": "2",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair FUSD-OSMO",
            "description": "adding extended pairs FUSD-OSMO same pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
    ...
    [
        "AETH-OSMO",
        {
            ...
            "asset_out_pool_id": "2",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair AETH-OSMO",
            "description": "adding extended pairs AETH-OSMO cross pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "FUSD-OSMO",
        {
            ...
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair FUSD-OSMO",
            "description": "adding extended pairs FUSD-OSMO cross pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
    ...
    [
        "OSMO-AETH",
        {
            ...
            "asset_out_pool_id": "1",
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair OSMO-AETH",
            "description": "adding extended pairs OSMO-AETH cross pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "FUSD-AETH",
        {
            ...
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair FUSD-AETH",
            "description": "adding extended pairs FUSD-AETH cross pool",
            "deposit": "10000000uaeth",
        },
    ],
    [
        "ATOM-AETH",
        {
            ...
            "min_usd_value_left": "100000000000",
            "title": "Add Extended pair ATOM-AETH",
            "description": "adding extended pairs ATOM-AETH cross pool",
            "deposit": "10000000uaeth",
        },
    ],
]
...
WASM_CONTRACTS = [
    {
        ...
        "contractLink": "https://github.com/aether-official/test-wasm-artifacts/raw/main/token_vesting.wasm",
    ...
    },
    {
        ...
        "contractLink": "https://github.com/aether-official/test-wasm-artifacts/raw/main/locking_contract.wasm",
        ...
        "initator": {
            ...
            "vesting_contract": "",
            "foundation_addr": ["aether1rljg3wwgv6qezu3p05vxny9pwk3mdwl0ja407z"],
            ...
            "min_lock_amount" : "4",
            "admin":"aether1663kc7kwlqxg5s35wuq4nleuqvy5j2tstlkeg2"
        },
    ...
    },
    {
        ...
        "contractLink": "https://github.com/aether-official/test-wasm-artifacts/raw/main/governance.wasm",
...
WASM_PROPOSALS = [
    ...
    },
    {
        ...
        "content": {
            "propose": {
                "propose": {
                    "title": "New proposal for add vault pair for AETH C - FUSD",
                    "description": "This is a base execution proposal to add AETH C - FUSD vault pair with given Vault properties a. Liquidation ratio : 140 % b. Stability Fee : 1%  c. Liquidation Penalty : 12% d. DrawDown Fee : 1% e. Debt Cieling : 100000000 FUSD f. Debt Floor : 100 FUSD ",
                    "msgs": [
                        {
        ...
        "content": {
            "propose": {
                "propose": {
                    ...
                    "description": "This is an base  execution proposal to initialise FUSD and HARBOR pair for Surplus and dutch auction with Debt Threshold being  1000 FUSD and Surplus Threshold as 100000000 FUSD  ",
                    "msgs": [
                        {
    ...
    },
    {
        ...
        "content": {
            "propose": {
                "propose": {
                    "title": "New proposal to whitelist FUSD for locker",
                    "description": "This is an base  execution proposal to add use FUSD as locker deposit asset.",
                    "msgs": [
                        {
    ...
    },
    {
        ...
        "content": {
            "propose": {
                "propose": {
                    "title": "New proposal for add pair for AETH",
                    "description": "This is an base proposal execution proposal to add AETH-FUSD n.",
